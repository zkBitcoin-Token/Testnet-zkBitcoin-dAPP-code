...
const txHandle = await this.contractABASStaking.MAXstakePermit(this.Permit_user, this.Permit_spender, this.Permit_value, this.Permit_deadline, this.Permit_v, '0x'+this.Permit_r, '0x'+this.Permit_s);
...
console.log("22221BOGIE2", userAddy );
  ...
  const txHandle2 = await this.contractABASStaking.stakePermit(bigNumber.toString(), this.Permit_user, this.Permit_spender, this.Permit_value, this.Permit_deadline, this.Permit_v, '0x'+this.Permit_r, '0x'+this.Permit_s);
